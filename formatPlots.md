...
Here is an example .matplotlibrc which makes plots of suitable format for publication. It makes the default matplotlib window,
  * high DPI
  * good size for papers
  * good font to plot ratio
  * can save in vector format (i use eps)

it is distributed with the mwavepy source package (zip,tar.gz) under the examples directory. you can also download it [here](http://mwavepy.googlecode.com/svn/trunk/examples/matplotlibrc) . Unless you have customized your matplotlib setup, place it in ~/.matplotlib/ and settings will take effect next time you start ipython or run a python script.
...
lines.linewidth   : .750     # line width in points
...
patch.linewidth   	: .50     # edge width in points
...
font.size           : 10.0
#font.serif          : Times, Bitstream Vera Serif, New Century Schoolbook, Century Schoolbook L, Utopia, ITC Bookman, Bookman, Nimbus Roman No9 L, Times New Roman,  Palatino, Charter, serif
...
#font.monospace      : Courier, Bitstream Vera Sans Mono, Andale Mono, Nimbus Mono L, Courier New, Courier, Fixed, Terminal, monospace
...
figure.figsize   : 5.5, 3.5    # figure size in inches
...
figure.subplot.left	    : 0.12  # the left side of the subplots of the figur
